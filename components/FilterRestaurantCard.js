...
export default function FilterRestaurantCard({visible, setFiltered}) {
...
return (
    ...
    <Modal onRequestClose={visible}
           transparent={true}
           animationType="slide"
           style={styles.modal}
           >

                <ScrollView onLayout={() => setIsShown(true)}>
                    <TouchableOpacity activeOpacity={1}>
                        <View style={styles.main}>
                            ...
                            {isShown && <FadeInAnimation>{settingsArray}</FadeInAnimation> }
...
main: {
    ...
    paddingTop: 30,
    paddingBottom: 200,
    height: Dimensions.get('screen').height + Dimensions.get('screen').height * 0.2
